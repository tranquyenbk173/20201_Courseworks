...
class AddressExtractor():
    def __init__(self):
        ...
        self.phuong_list = {
                ...
                'long bien': ['bo de', 'cu khoi', 'duc giang', 'gia thuy', 'giang bien', 'long bien', 'ngoc lam', 'ngoc thuy', 'phuc dong', 'phuc loi', 'sai dong', 'thach ban', 'thuong thanh', 'viet hung'],
                ...
                'ba vi': ['tay dang', 'ba trai', 'ba vi', 'cam linh', 'cam thuong', 'chau son', 'chu minh', 'co do', 'dong quang', 'dong thai', 'khanh thuong', 'minh chau', 'minh quang', 'phong van', 'phu chau', 'phu cuong', 'phu dong', 'phu phuong', 'phu son', 'son da', 'tan hong', 'tan linh', 'thai hoa', 'thuan my', 'thuy an', 'tien phong', 'tong bat', 'van hoa', 'van thang', 'vat lai', 'yen bai'], 
                ...
                'dan phuong': ['phung', 'dan phuong', 'dong thap', 'ha mo', 'hong ha', 'lien ha', 'lien hong', 'lien trung', 'phuong dinh', 'song phuong', 'tan hoi', 'tan lap', 'tho an', 'tho xuan', 'thuong mo', 'trung chau'],
                ...
                'me linh': ['chi dong', 'quang minh', 'chu phan', 'dai thinh', 'hoang kim', 'kim hoa', 'lien mac', 'me linh', 'tam dong', 'thach da', 'thanh lam', 'tien phong', 'tien thang', 'tien thinh', 'trang viet', 'tu lap', 'van yen', 'van khe'],
